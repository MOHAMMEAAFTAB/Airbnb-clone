...
//         const coordinate = await getcordinates(location);
...
//         if (!req.file) {
//             newlisting.image.filename = "NEW LISTING";
//         } else {
...
//         console.log(newlisting);
//     } catch (err) {
//         next(new expressError(500, "Something went wrong while creating the listing."));
//     }
// };
